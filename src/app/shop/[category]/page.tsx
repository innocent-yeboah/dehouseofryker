...
export default async function CategoryPage({ params }: PageProps) {
  ...
  return (
    <StorefrontChrome>
      ...
      {kind === "oil" ? (
        <p className="mt-2 max-w-2xl text-sm text-muted">
          Almas Play Blue concentrated perfume oil (100 g), Almas 121 VIP, Silver Black, Almas
          Royal Black, Almas Real XX, Almas d'nill, Almas Bushra, and Almas Chocolate Musk
          concentrated perfume oils (100 g, alcohol-free), Almas Crimson Chandelier concentrated
          perfume oil (100 g), Al Kausar Aqua 212 concentrated attar (100 g, alcohol-free), Crystal
          Amber inspired perfume, YZS 50 ml eaux de parfum, YZS Wilderness, Carpet of Flowers, Black
          Crow, Red Gemstone, and Sunshine Amber (35 ml), Veyes 9 am and Dawn eaux de parfum (100 ml),
      ...
      {kind === "wellness" ? (
        <p className="mt-2 max-w-2xl text-sm text-muted">Everyday wellness supplements.</p>
      ) : null}
      {products.length === 0 ? (
