...
export default function WholesalePage() {
  return (
    <StorefrontChrome>
      <h1 className="font-serif text-4xl">Wholesale</h1>
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        <a
          ...
          className="bg-house-gold px-6 py-3 text-sm font-medium text-ink"
        >
          WhatsApp wholesale
        </a>
        <Link href="/shop/bottles" className="border border-house-gold px-6 py-3 text-sm text-deep-gold">
          Small-qty bottles
        </Link>
      </div>
    </StorefrontChrome>
