...
export default function BrandingPage() {
  return (
    <StorefrontChrome>
      <h1 className="font-serif text-4xl">Branding and packaging</h1>
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        <Link href="/shop/packaging" className="bg-house-gold px-6 py-3 text-sm font-medium text-ink">
        ...
        <a
          ...
          className="border border-house-gold px-6 py-3 text-sm text-deep-gold"
        >
